...
jsPsych.plugins['survey-likert'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      /* change question.name to question.prompt */
      // var options_string = '<ul class="jspsych-survey-likert-opts" data-name="'+question.name+'" data-radio-group="Q' + question_order[i] + '">';
      var options_string = '<ul class="jspsych-survey-likert-opts" data-name="'+question.prompt+'" data-radio-group="Q' + question_order[i] + '">';
